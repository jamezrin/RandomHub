...
public class ConfigEntries implements ConfigEntryHolder {
    ...
    public static final ConfigEntry<Integer> DELAY_AMOUNT = new ConfigEntry<>(0, "settings.connect_delay", 0);
    ...
    public static final ConfigEntry<String> CONNECTING_MESSAGE = new ConfigEntry<>(0, "messages.connected", "&aTeleporting to a lobby in {amount} seconds");
}
